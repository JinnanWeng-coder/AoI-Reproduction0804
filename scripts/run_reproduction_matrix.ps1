...
$arguments = @("--device", $Device, "--checkpoint-every", $CheckpointEvery, "--stage", $Stage, "--eval-purpose", $EvalPurpose, "--eval-episodes", $EvalEpisodes, "--output-root", $OutputRoot, "--log-dir", $LogDir)
